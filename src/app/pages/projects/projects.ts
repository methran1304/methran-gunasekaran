...
export class ProjectsComponent implements OnInit {
  ...
  projects: Work[] = [
    ...
    },
    {
      title: 'Document360',
      description:
        'Built full-stack features for a global SaaS platform, owning the identity module while handling frontend and backend development with performance optimizations.',
